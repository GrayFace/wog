/*
** Character types.
** Separated from lj_char.h to allow modification of valid indentifier characters in Lua code.
** Public domain.
*/
...
#define lj_char_isa(c, t)	((lj_char_bits_lua+1)[(c)] & t)
...
LJ_DATA uint8_t lj_char_bits_lua[257];
