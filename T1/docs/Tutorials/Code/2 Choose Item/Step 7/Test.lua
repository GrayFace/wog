...
local choices = {
	dialogs.Pcx{File = "HPL002KN.pcx", Caption = "Text", Hint = "Steal his chainmail!"},
	dialogs.Def{File = "twcrport.def", Frame = 6, Caption = "Text", Hint = "Griffin Nuggets!"},
	dialogs.Def{File = "artifact.def", Frame = 6, Caption = "Text", Hint = "Go camping!"},
}

dlg = dialogs.new{ShowLongHints = true}
dlg:Add(
	dialogs.AlignV{
	...
	list:AddItem(dialogs.AlignV{AlignX = 0.5, SpaceY = 3,
		dialogs.AlignLayers{
			...
			dialogs.Frame{Index = i, Visible = false, OnClick = FrameClick,
				LongHint = it.LongHint or it.Hint,
...
local id = dlg:Show()
return (id == 30722 and lastFrame.Index or 0)
