...
#define WOG_STRING_VERSION "3 . 59a Build 4\nBuilt on "__DATE__/*""BETAVERSION""*/
...
// наем существ
//BB0 80 0C 64 00 00 00 00 00 00 00 00 00 FF FF FF FF Аd         ____
...
//C40 01 00 00 00 00 00 00 00 F0 C8 7D 01 01 00 00 00        Ё+}
